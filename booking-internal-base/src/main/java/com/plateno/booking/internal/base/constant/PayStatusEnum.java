 ...
 * <pre>
 * 订单状态
 * 支付状态：1待付款、2已取消 3待发货，4已发货，5已完成 6退款审核中、7已退款，8退款审核不通过 9已删除,10 退款中,11支付中,12支付失败,13退款失败
 * 显示状态：100待付款、200已取消、300待发货、400已发货、500已完成、600退款中、700已退款、800退款审核不通过401部分发货
 * </pre>
 * @author mogt
 * @date 2016年11月9日
 */
