...
public class MOrderBAOTAOMallBookingServiceTest {
    ...
    public void testAddBooking() throws OrderException, Exception {
        ...
        MOrderGoodsParam orderGoodsParam2 = new MOrderGoodsParam();
        orderGoodsParam2.setGoodsId(14L);
        orderGoodsParam2.setQuantity(1);
        List<MOrderGoodsParam> goodsList = new ArrayList<MOrderGoodsParam>();
        goodsList.add(orderGoodsParam);
        goodsList.add(orderGoodsParam2);
        addBookingParam.setGoodsList(goodsList);
        addBookingParam.setTotalAmount(13800 + 4300);
        ...
        System.out.println(JsonUtils.toJsonString(addBookingParam));
