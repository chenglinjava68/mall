...
public class OrderLogService {
	 ...
	 * 异步保存
	 */
	public void saveTCCreateOrderLog(final String exception,final String request,final String response,final Integer channel){
		try{
	...
	public void saveGSOrderLog(String tradeNo, Integer orderStatus, String order_desc, String remark, Integer channel,Integer viewStatus) {
		try{
	...
	public void saveGSOrderLog(String tradeNo, Integer orderStatus, String order_desc, String remark, Integer channel,Integer viewStatus,String description) {
		try{
			GsOrderLog orderLog = new GsOrderLog();
			orderLog.setChannel(channel);
			orderLog.setCreateTime(new Date());
